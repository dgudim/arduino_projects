...
void update_effects() {
    ...
    case EffectMode::Rainbow:
        ...
        break;
    case EffectMode::Twinkle:
        twinkle(parameter1 * 255, parameter2 * 255, parameter3 * 255);
        break;
    case EffectMode::Rainbow2D:
